...
$.result = [];
// 要扔白菜的账号ck
$.cookieArr = ["pt_key=xxx;pt_pin=xx;"];
// 要扔的白菜数量
const cnt = 100;
$.currentCookie = '';
$.petid = [];
...
function taskUrl2(function_path, body, stk) {
