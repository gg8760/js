...
=========================Loon=============================
[Script]
cron "0 0 * * *" script-path=jd_fruit.js,tag=东东农场
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    $.shareCodesArr = ["c8f3876f3ea24dedbb174868ad53e4d3","dad356ebad9a4de6ab8fdd774b2ea945","f571dfa3cb39431191a59f9d30475a62","667ebac5844e418d98393004362eb282","b5eb8b992bdd42838355d79e1d1131bd"];
    if ($.isNode()) {
