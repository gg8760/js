...
[Script]
cron "20 7-21/1 * * *"  script-path=jiuzhang_account_11.js,tag=九章头条11-哥

*/


const $ = new Env('九章头条11-哥');//声明必须
...
// 	"data": {
// 		"name": "🌸餐饮项目总监-李格",
// 		"invite_code": "83027Gx9",
// 		"id": 220278,
// 		"avatar": "https:\/\/thirdwx.qlogo.cn\/mmopen\/vi_32\/aRRlbUiciaQG3XvDDcD30gLnWVOkKSibDwicFWOJD8vIibEAGbz3BKMstBvOLypMnicsyeiacWSKibMZgazuib5NbbwnTpw\/132",
// 		"mobile": "13031720935",
// 		"sex": 0,
// 		"integral": 0,
// 		"money": 0,
...
// 			"status": 1,
// 			"nickname": "🌸餐饮项目总监-李格",
// 			"headimgurl": "https:\/\/thirdwx.qlogo.cn\/mmopen\/vi_32\/aRRlbUiciaQG3XvDDcD30gLnWVOkKSibDwicFWOJD8vIibEAGbz3BKMstBvOLypMnicsyeiacWSKibMZgazuib5NbbwnTpw\/132"
// 		},
// 		"price": 12.87,
// 		"worth": 0
// 	},
...
// https://api.st615.com/v1/article/detail?token=${cookie}&id=${id}&os=Android%206.0.1&device=vivo%20Y55A
    
    $.get(apiHost(`v1/article/detail?token=${cookie}&id=${id}&os=Android%206.0.1&device=vivo%20Y55A`), async (error, resp, data) => {
      try {
        let obj = JSON.parse(data)
        let ctype = type == 0 ? "文章" : "视频";
