...
let headerArray = [
    {
        "userid": "dcb44aae7bd2101678b92caf788748cd",
        "Authorization": "TmpFelptVmlORGxrTkRkaE5XWXlObVF3WlRZME9XUTVZakptWW1RMU5HVT18MTYyOTIxNTY1OTU2NjUzNDczNXw4M2QyNzQ4ODY4YjhlYzRkZmZhYmE5NTNiZGI1MmI5Yjg3YjA3MTU5",
        "appId": "19227f89ea1a166451593601eb8a1b4f",
        "language": "zh_CN",
        "cityCode": 370100,
        "MarketChannelName": "Iphone",
        "Cookie": "beegosessionID=eab509018687256f1f000a33967421f7",
        "ssid": "dc954980-79ef-4f72-8817-c48b57fac9fe",
        "Accept-Encoding": "gzip, deflate",
        "cuuid": "66495dbee21eea0a627158095a1e85d7",
        "uuid": "8e7ba89363784e24bc15680b2857b30d",
        "gpsCityCode": 370100,
        "hwModel": "iPhone13,2",
    ...
    {
        "userid": "1dfeed227fcea402895f1f0e745fc10b",
        "Authorization": "T1dFeVl6SXdNbVF5Wm1ZM04yTXlZVFprTnpBNVpEUTJOV1JpT0RabFpERT18MTY0MjE2NzI3ODI2NzIwMjcwNXwxZjVmNWZiMWY5YmMzMWE4MTgyNmMyNmViNzJmMjNkMWI1Mjg4N2M4",
        "appId": "19227f89ea1a166451593601eb8a1b4f",
        "language": "zh_CN",
        "cityCode": 370100,
        "MarketChannelName": "Iphone",
        "Cookie": "",
        "ssid": "d5e05887-09be-4046-a637-fdce740b0377",
        "Accept-Encoding": "gzip, deflate",
        "cuuid": "30d563c5bf1cfe8ea1a07873e6d19a39",
        "uuid": "ef4f8285c8484d038fdfda94b3f6c2f2",
        "gpsCityCode": 370100,
        "hwModel": "iPhone 7",
        "Accept-Language": "zh-Hans;q=1",
        "countryCode": "CN",
        ...
        'User-Agent': 'Dsj/Client1.2',
        'Generation': 'com.dianshijia.mobile.ios',
        'GpsLontitude': '117.1421',
        'Cache-Control': 'no-cache',
        'GpsLatitude': '36.70034',
        'hwBrand': 'iPhone',
        "Content-Type": "application/x-www-form-urlencoded",
        "user_level_score": 2,
        'erid': 69521,
...
//     return new Promise((resolve, reject) => {
//         const toQQreadboxurl = {
//             url: `http://api.gaoqingdianshi.com/api/redpack/receive`,
//             headers: JSON.parse(signheaderVal),
//         };
//         $.get(toQQreadboxurl, async (error, response, data) => {
//             try {
...
// function apiHost() {
//     return {
//         url: `http://api.gaoqingdianshi.com/api/pay/documents`,
//         headers: JSON.parse(signheaderVal),
//         body: JSON.stringify({"document":"sign1"})
//     }
//   }
...
//     return new Promise((resolve, reject) => {
//       $.post(apiHost(), async (error, resp, data) => {
//         try {
