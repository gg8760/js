...
const $iosrule = new Env('惠头条');//声明必须
const huitoutiao = "惠头条";
var pathUrl = "";
var urlBody, readArticleBody, readVideoBody, videoBody520, userId, loginId;
...
var readArticleNumber = 24;
var readArticleWaitTime = 30000;

var readVideoNumber = 24;
var readVideoWaitTime = 30000;
...
var urlBodyArray = [], videoBody520Array = [], readArticleBodyArray = [], readVideoBodyArray = [], pathUrlArray = [], userIdArray = [], loginIdArray = [];
...
!(async () => {
  ...
  console.log(`========================================`);
  console.log(`========================================`);
  console.log(`===========【总共提供${urlBodyArray.length}个账号】=============`);
  console.log(`========================================`);
  console.log(`========================================`);

  
  for (let index = 0; index < urlBodyArray.length; index++) {

    breakReadArticle = false
    breakReadVideo = false
    console.log(`\n🏖🏖🏖🏖🏖🏖🏖🏖🏖 开始账号${index + 1}的任务 🏖🏖🏖🏖🏖🏖🏖🏖🏖🏖\n`);
    pathUrl = pathUrlArray[index]
    urlBody = urlBodyArray[index]
    readArticleBody = readArticleBodyArray[index]
    readVideoBody = readVideoBodyArray[index]
    videoBody520 = videoBody520Array[index]
    userId = userIdArray[index]
    loginId = loginIdArray[index]
    ...
    if (new Date().getHours() >= 15 && new Date().getHours() <= 22) {
...
function initDataSource() {
  ...
  let userid1 = 114661131
  let loginid1 = "831c4fa204984e7ca7271c6da429fcab"
  let appVersion1 = 1043
  let versionName1 = "4.6.0"
  let pathUrl = `userId=114661131&loginId=831c4fa204984e7ca7271c6da429fcab&appVersion=1043&platform=1&versionName=4.6.0`
  
  let urlBody = JSON.stringify({
  ...
  let videoBody520 = JSON.stringify({
    "platform": 1,
    "loginId": loginid1,
    "versionName": versionName1,
    "userId": userid1,
  ...
  let readArticleBody = JSON.stringify({
    "versionName": versionName1,
    "platform": 1,
    "count": 3,
    "userId": userid1,
  ...
  let readVideoBody = JSON.stringify({
    "versionName": versionName1,
    "platform": 1,
    "count": 0,
    "userId": userid1,
  ...
  let userid2 = 153646125
  let loginid2 = "00dbe52c6b5344a9a2ccbe029868aa22"
  let appVersion2 = 1043
  let versionName2 = "4.6.0"
  let pathUrl2 = `userId=${userid2}&loginId=${loginid2}&appVersion=${appVersion2}&platform=1&versionName=${versionName2}`

  let urlBody2 = JSON.stringify({
    "loginId": loginid2,
  ...
  let videoBody520_2 = JSON.stringify({
    "platform": 1,
    "loginId": loginid2,
    "versionName": versionName2,
    "userId": userid2,
  ...
  let readArticleBody2 = JSON.stringify({
    "versionName": versionName2,
    "platform": 1,
    "count": 3,
    "userId": userid2,
  ...
  let readVideoBody2 = JSON.stringify({
    "versionName": versionName2,
    "platform": 1,
    "count": 0,
    "userId": userid2,
  ...
  pathUrlArray = [pathUrl, pathUrl2]
  urlBodyArray = [urlBody, urlBody2]
  videoBody520Array = [videoBody520, videoBody520_2]
  // 更新文章阅读时间
  readArticleBodyArray = [readArticleBody, readArticleBody2]
  // 更新视频阅读时间
  readVideoBodyArray = [readVideoBody, readVideoBody2]
  userIdArray = [userid1, userid2]
  loginIdArray = [loginid1,loginid2]
    ...
    $iosrule.post(url, async (error, resp, data) => {
      try {
        ...
        if (obj.statusCode == 200) {
          ...
          if (obj.state == 1 && obj.msg.indexOf("超过阈值") > 0) {
...
// https://api.cashtoutiao.com/frontend/scholarship/video/task/info?userId=114661131&loginId=8a99cc70677d4f8ab2a7e57a5b3d36cf&appVersion=1043&platform=1&versionName=4.6.0
// {
// 	"leftCredit": 440,
// 	"statusCode": 200,
// 	"taskList": [{
