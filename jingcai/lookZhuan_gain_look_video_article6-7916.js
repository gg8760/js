...
[Script]
cron "22 16,18 * * *"  script-path=lookZhuan_gain_look_video_article6-7916.js,tag=晶彩看点看看赚&视频啊&文章
*/
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME6;
    let lookArray = look.LOOK_GAIN_LOOK6["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK6["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE6.split('\n');
    let videoBodysArray = look.LOOK_VIDEO6.split('\n');
