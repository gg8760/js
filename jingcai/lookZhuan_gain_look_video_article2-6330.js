...
[Script]
cron "22 6,12 * * *"  script-path=lookZhuan_gain_look_video_article2-6330.js,tag=晶彩看点看看赚&视频啊&文章
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME2;
    let lookArray = look.LOOK_GAIN_LOOK2["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK2["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE2.split('\n');
    let videoBodysArray = look.LOOK_VIDEO2.split('\n');
