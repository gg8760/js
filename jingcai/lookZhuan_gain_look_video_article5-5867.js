...
[Script]
cron "22 6,12 * * *"  script-path=lookZhuan_gain_look_video_article5-5867.js,tag=晶彩看点看看赚&视频啊&文章
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME5;
    let lookArray = look.LOOK_GAIN_LOOK5["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK5["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE5.split('\n');
    let videoBodysArray = look.LOOK_VIDEO5.split('\n');
