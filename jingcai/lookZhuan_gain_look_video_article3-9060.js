...
[Script]
cron "22 6,12 * * *"  script-path=lookZhuan_gain_look_video_article3-9060.js,tag=晶彩看点看看赚&视频啊&文章
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME3;
    let lookArray = look.LOOK_GAIN_LOOK3["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK3["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE3.split('\n');
    let videoBodysArray = look.LOOK_VIDEO3.split('\n');
