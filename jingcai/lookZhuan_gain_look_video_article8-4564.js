...
[Script]
cron "22 16,18 * * *"  script-path=lookZhuan_gain_look_video_article8-4564.js,tag=晶彩看点看看赚&视频啊&文章
*/
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME8;
    let lookArray = look.LOOK_GAIN_LOOK8["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK8["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE8.split('\n');
    let videoBodysArray = look.LOOK_VIDEO8.split('\n');
