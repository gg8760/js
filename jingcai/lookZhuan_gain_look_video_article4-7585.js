...
[Script]
cron "22 6,12 * * *"  script-path=lookZhuan_gain_look_video_article4-7585.js,tag=晶彩看点看看赚&视频啊&文章
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME4;
    let lookArray = look.LOOK_GAIN_LOOK4["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK4["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE4.split('\n');
    let videoBodysArray = look.LOOK_VIDEO4.split('\n');
