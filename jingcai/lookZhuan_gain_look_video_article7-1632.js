...
[Script]
cron "22 16,18 * * *"  script-path=lookZhuan_gain_look_video_article7-1632.js,tag=晶彩看点看看赚&视频啊&文章
*/
...
!(async () => {
    ...
    timebodyVal = look.LOOK_ATIME7;
    let lookArray = look.LOOK_GAIN_LOOK7["look"].split('\n');
    let gainArray = look.LOOK_GAIN_LOOK7["gain"].split('\n');
    let articleBodysArray = look.LOOK_ARTICLE7.split('\n');
    let videoBodysArray = look.LOOK_VIDEO7.split('\n');
