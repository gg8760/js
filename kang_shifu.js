...
*/
let wx_yml_ksf_data = [
    // 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJVU0VSX0lEIjoiNjg5MTMzNTU1NDgzMTgxNDY1Ny1XRUIiLCJleHAiOjE2NDUyNDk1MDd9.nT2PFy0fAcFxABtiN8EwSLS3pFN1d0XnMxXFde1wsFE',
    // 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJVU0VSX0lEIjoiNjg5MTMyODU3MDIzMzUyNDIyNS1XRUIiLCJleHAiOjE2NDUyNDg3NDJ9.c3n0bO9cRta7A9oQp85DDlPuo2LDalk9UEo6TdRVlfI',
    // 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJVU0VSX0lEIjoiNjg5MTUyMjMxNzE3NzEzMTAwOS1XRUIiLCJleHAiOjE2NDUyNDk1ODB9.NV1UCyTR2R8KNAka27HrTKYTpOD0E0cy3LhRfweuk3s',
    // 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJVU0VSX0lEIjoiNjg5MTUyMjkxNjk2Njc5NzMxMy1XRUIiLCJleHAiOjE2NDUyNDk3NTR9.VCWUpeXrl0CXHX9wt6b7XLjG59KAA4SDAiGn64Ulgbo',
]

let yml_ksf_draw='true'
!(async () => {
    ...
    return new Promise((resolve) => {
        let url = {
            ...
            headers: {
                ...
                "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 14_8 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.17(0x1800112e) NetType/WIFI Language/zh_CN",
            },
            // body: {},
