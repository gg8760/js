...
[Script]
cron "5 7-13/2 * * *"  script-path=youth_readArticleAndVideo_vxGE0410.js,tag=中青看点阅读文章，视频_13-vxGE0410
...
if (youth.youthRead13_1 && youth.youthRead13_1.indexOf('&') > -1) {
    YouthArticleBodys = youth.youthRead13_1.split('&');
} else if (youth.youthRead13_1 && youth.youthRead13_1.indexOf('\n') > -1) {
    YouthArticleBodys = youth.youthRead13_1.split('\n');
} else {
    YouthArticleBodys = [youth.youthRead13_1]
}

if (youth.YOUTH_VIDEO13 && youth.YOUTH_VIDEO13.indexOf('&') > -1) {
    YouthVideoBodys = youth.YOUTH_VIDEO13.split('&');
} else if (youth.YOUTH_VIDEO13 && youth.YOUTH_VIDEO13.indexOf('\n') > -1) {
    YouthVideoBodys = youth.YOUTH_VIDEO13.split('\n');
} else {
    YouthVideoBodys = [youth.YOUTH_VIDEO13]
}

timebodyVal = youth.YOUTH_ATIME13

let dicItem = youth.YOUTH_GAIN_LOOK13
...
let gainbody = '';
let articlebody = '';
let dicItemAndroid = youth.YOUTH_GAIN_LOOK_ANDROID_13
