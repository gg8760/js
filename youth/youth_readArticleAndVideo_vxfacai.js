...
[Script]
cron "5 7-13/2 * * *"  script-path=youth_readArticleAndVideo_vxfacai.js,tag=中青看点阅读文章，视频_10-vx_facai

*/

const $ = new Env("中青看点阅读文章，视频_10-vx_facai")
...
if (youth.youthRead10_1 && youth.youthRead10_1.indexOf('&') > -1) {
    YouthArticleBodys = youth.youthRead10_1.split('&');
} else if (youth.youthRead10_1 && youth.youthRead10_1.indexOf('\n') > -1) {
    YouthArticleBodys = youth.youthRead10_1.split('\n');
} else {
    YouthArticleBodys = [youth.youthRead10_1]
}

if (youth.YOUTH_VIDEO10 && youth.YOUTH_VIDEO10.indexOf('&') > -1) {
    YouthVideoBodys = youth.YOUTH_VIDEO10.split('&');
} else if (youth.YOUTH_VIDEO10 && youth.YOUTH_VIDEO10.indexOf('\n') > -1) {
    YouthVideoBodys = youth.YOUTH_VIDEO10.split('\n');
} else {
    YouthVideoBodys = [youth.YOUTH_VIDEO10]
}

timebodyVal = youth.YOUTH_ATIME10

let dicItem = youth.YOUTH_GAIN_LOOK10
...
let gainbody = '';
let articlebody = '';
let dicItemAndroid = youth.YOUTH_GAIN_LOOK_ANDROID_10
