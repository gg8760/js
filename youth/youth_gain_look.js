...
!(async () => {
    ...
    let array = youth.YOUTH_GAIN_LOOK

    console.log(`------您共提供${array.length}个中青账号----\n`)


    for (let index = 0; index < array.length; index++) {
        let dicItem = array[index];
        let accountInfo = dicItem["accountInfo"]
        let lookString = dicItem["youthLook"]
        let gainString = dicItem["youthGain"]

        let lookArray = lookString.split('\n');
        let gainArray = gainString.split('\n');

        // console.log("lookString--------------",lookString)
...
//     "message": "\u6267\u884c\u6210\u529f",
//     "items": {
//         "id": "4b6cfd3ae60cacf4f0802e39ba15a60e",
//         "playSound": 1,
//         "read_score": 18,
//         "times_title": "",
//         "complete": 0,
