...
'W2I2jlptXMtwuzvAi9w3v6+vC1pAxiEgZMgRoY9buDHs3HB+X7Nah+HBkucUBFgaugAYlceMbMuvgyvlzyDpJ3LbSNtGqTUgY35o71kbmqguYovp4OBMGkXuVedaWKz340gCSx2a+PdJkuDE+odN7Nqi9Jn0bHu47Koa+X5gtWE='] 

 let chyutokenArr = ['F0E76898-62D0-4F97-A3A2-7CAFB2129174_cyjsb',
 'F26DA09E-18C5-4124-8B6A-498EE8CE53D7_cyjsb',
 '4AB64659-4AB7-4ECD-838E-5577E8D9434B_cyjsb',
'6D555B2A-E5E6-403F-85E4-5E2B6F8E1FDA_cyjsb'];
         ...
         for (let i = 0; i < chyutokenArr.length; i++) {
             ...
             if (chyutokenArr[i]) {
                 ...
                 for(let j=0; j<videoCount; j++){
                     let sjTimes = randomNum(28000,35000)
