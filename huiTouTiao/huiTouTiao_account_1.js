...
const $iosrule = new Env('惠头条账号1-峰');//声明必须
const huitoutiao = "惠头条账号1-峰";
var pathUrl = "";
var urlBody, readArticleBody, readVideoBody, videoBody520, userId, loginId, appVersion ,versionName ,platform ;

var update520ArticleNumber = 1000;
var update520ArticleWaitTime = 1000;

var update520VideoNumber = 1000;
var update520VideoWaitTime = 1000;

var readArticleNumber = 50;
var readArticleWaitTime = 3000;

var readVideoNumber = 50;
var readVideoWaitTime = 3000;
...
!(async () => {
  ...
  // for (let index = 0; index < accountArray.length; index++) {
    ...
    // "accountInfo": "惠头条账号1-峰",
    // "accountMobile": "18253169060",
    // "withdrawAccount": "vx峰",
    // "openId": "",
    // "userId": "114661131",
    // "loginId": "",
